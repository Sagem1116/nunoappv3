  ...
  return (
    <div className="page-enter space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard icon={BadgeDollarSign} label="Saldo Pessoal" value={fmt(stats.balance)}
          accent={stats.balance >= 0 ? "text-sky-400" : "text-destructive"}
          subLabel={savingsTotal > 0 ? <><span className="text-muted-foreground">excluindo</span> <span className="text-emerald-400 font-medium">{fmt(savingsTotal)}</span> de poupanças</> : undefined} />
